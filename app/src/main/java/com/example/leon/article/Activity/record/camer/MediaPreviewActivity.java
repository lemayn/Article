package com.example.leon.article.Activity.record.camer;
...
import com.example.leon.article.Activity.record.camer.po.POThemeSingle;
import com.example.leon.article.Activity.record.camer.service.AssertService;
import com.example.leon.article.Activity.record.camer.ui.helper.ThemeHelper;
import com.example.leon.article.Activity.record.camer.ui.views.ThemeGroupLayout;
import com.example.leon.article.Activity.record.camer.ui.views.ThemeSufaceView;
import com.example.leon.article.Activity.record.camer.ui.views.ThemeView;
import com.example.leon.article.Activity.record.camer.utils.ConvertToUtils;
import com.example.leon.article.Activity.record.camer.utils.IsUtils;
...
public class MediaPreviewActivity extends BaseActivity implements
    ...
    private static String TAG = "FiDo";
    ...
    private void GetIntentData() {
        ...
        videoTitle = intent.getStringExtra(CommonIntentExtra.VIDEO_TITLE);
        videoContent = intent.getStringExtra(CommonIntentExtra.VIDEO_CONTENT);
    }
                        ...
                        .updateVideoAuthorLogo(
                                ...
                                getString(R.string.record_camera_author,
                                        getString(R.string.app_name)
                                                + " By "+ SPUtil.get(Constant.Share_prf.NAME,"most beautiful person in the world")), false);
                return result;
            }
