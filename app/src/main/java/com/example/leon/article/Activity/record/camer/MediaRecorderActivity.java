...
import com.example.leon.article.Activity.record.camer.ui.views.ProgressView;
...
//        Toast.makeText(this, "视频截图地址: " + mMediaObject.getOutputVideoThumbPath(), Toast.LENGTH_SHORT).show();
        ...
        intent.putExtra(CommonIntentExtra.VIDEO_TITLE,videoTitle);
        intent.putExtra(CommonIntentExtra.VIDEO_CONTENT,videoContent);
