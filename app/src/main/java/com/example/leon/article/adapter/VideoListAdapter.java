...
public class VideoListAdapter extends BaseAdapter {
    ...
    private List<VideoListBean.DataBean.VideoBean> items = new ArrayList<>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_listview_videolist, parent, false);
        }
        ...
        holder.tv_issue_content.setText(items.get(position).getTitle());
        holder.tv_issue_time.setText(items.get(position).getAddtime());
        holder.ll_videoList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    class IssueItemHolder {
        ...
        public IssueItemHolder(View view) {
            tv_issue_content = (TextView) view.findViewById(R.id.tv_videolist_content);
            tv_issue_time = (TextView) view.findViewById(R.id.tv_videolist_time);
            tv_issue_status = (TextView) view.findViewById(R.id.tv_videolist_status);
            ll_videoList = (LinearLayout) view.findViewById(R.id.ll_adapter_videolist);
        }
    }
