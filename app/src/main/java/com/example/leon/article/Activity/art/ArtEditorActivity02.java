...
public class ArtEditorActivity02 extends AppCompatActivity implements IEditorActivity, SelectPicturePopupWindow.OnSelectedListener, View.OnClickListener {
        ...
        photoSelectUtils = new PhotoSelectUtils(this, new PhotoSelectUtils.PhotoSelectListener() {
            ...
            public void onFinish(File outputFile, Uri outputUri) {
                if (outputUri != null) {
                    ...
                    Glide.with(ArtEditorActivity02.this)
                            .load(outputUri)
                            .centerCrop()
                            .transform(new CornersTransform(ArtEditorActivity02.this))
                            .crossFade()
                            .into(iv_insert);
                    ...
                    insertBitmap = imageCompress.compressFromUri(ArtEditorActivity02.this, options);
                }
            }
    ...
    private void callGallery() {
        ...
        Intent intent = new Intent(ArtEditorActivity02.this, PhotoSelectorActivity.class);
        ...
        Observable.create(new Observable.OnSubscribe<String>() {
            ...
            public void call(Subscriber<? super String> subscriber) {
                try {
                    ...
                    //插入的图片地址集合
                    List<String> photos = (List<String>) data.getExtras().getSerializable("photos");//path是选择拍照或者图片的地址数组
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bt_artEditor_addImg://点击了添加底部图片
                picturePopupWindow.showPopupWindow(ArtEditorActivity02.this);
                break;
        ...
        builder.setIcon(android.R.drawable.ic_dialog_alert)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        intent.setData(Uri.parse("package:" + ArtEditorActivity02.this.getPackageName()));
