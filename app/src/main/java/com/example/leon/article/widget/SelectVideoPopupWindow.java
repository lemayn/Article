...
public class SelectVideoPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public SelectVideoPopupWindow(Context context) {
        ...
        mMenuView = inflater.inflate(R.layout.layout_video_selector, null);
        takePhotoBtn = (Button) mMenuView.findViewById(R.id.video_selector_take_photo_btn);
        pickPictureBtn = (Button) mMenuView.findViewById(R.id.video_selector_pick_picture_btn);
        cancelBtn = (Button) mMenuView.findViewById(R.id.video_selector_cancel_btn);
        // 设置按钮监听
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.video_selector_take_photo_btn:
                if(null != mOnSelectedListener) {
                    mOnSelectedListener.OnSelected(v, 0);
                }
                break;
            case R.id.video_selector_pick_picture_btn:
                if(null != mOnSelectedListener) {
                    mOnSelectedListener.OnSelected(v, 1);
                }
                break;
            case R.id.video_selector_cancel_btn:
                if(null != mOnSelectedListener) {
