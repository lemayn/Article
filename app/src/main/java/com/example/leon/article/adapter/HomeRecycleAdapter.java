...
//        Log.i("MyTest", "text"+text);
    ...
    public class HolderTypeHead2 extends RecyclerView.ViewHolder {
        ...
        public HolderTypeHead2(View itemView) {
            ...
            lin_recommend.setEnabled(false);
            lin_excellent.setEnabled(true);

            imagview_recommend.setSelected(true);
            imagview_good.setSelected(false);
            textveiw_good.setTextColor(context.getResources().getColor(R.color.colorGrey));
            textveiw_recommend.setTextColor(context.getResources().getColor(R.color.colorRed));
        }
    }
