package com.example.leon.article.Activity.record.camer.utils;
...
public class ToastUtils {
	...
	public static void showToast(int resID) {
		showToast(app.getContext(), Toast.LENGTH_SHORT,
				resID);
	}

	public static void showToast(String text) {
		showToast(app.getContext(), Toast.LENGTH_SHORT, text);
	}
	...
	public static void showLongToast(int resID) {
		showToast(app.getContext(), Toast.LENGTH_LONG, resID);
	}
	...
	public static void showLongToast(String text) {
		showToast(app.getContext(), Toast.LENGTH_LONG, text);
	}
